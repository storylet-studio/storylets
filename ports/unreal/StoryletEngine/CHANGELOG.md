...
- **`ApplyLiveBundle` hands the bags over** on the game's registry: the old core's bags leave keeping their values and the new core claims them as it registers, and a refused swap puts everything back.
