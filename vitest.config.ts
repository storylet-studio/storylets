...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "@storylet-studio/wire": fileURLToPath(new URL("./packages/wire/src/index.ts", import.meta.url)),
      "@storylet-studio/client": fileURLToPath(new URL("./packages/client/src/index.ts", import.meta.url)),
      "@storylet-studio/station-kit": fileURLToPath(new URL("./packages/station-kit/src/index.ts", import.meta.url)),
