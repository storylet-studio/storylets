---
title: Reviewing
description: Leave threaded comments on any item, drop them on a canvas as markers, and walk through every open thread one at a time.
sidebar:
  label: Reviewing
---

Every item in a project can carry a comment thread, whether the project, a box, a deck, a
card, a hand, a tag group, or an outcome. Comments are stored with the project and travel
through version control like everything else, and they never go into the bundle your game
loads.
