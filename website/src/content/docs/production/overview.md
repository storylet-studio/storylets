...
ship?", which means a producer, a lead, or the author wearing that hat on a Friday afternoon.
Designing a card isn't the same as knowing a player can ever see it, and a storylet system is
good at hiding the difference. Content is gated on state, so a condition nobody satisfies
makes a card that exists, validates, compiles, and never appears.

If you're designing rather than checking, head to [Storyletter](/storyletter/overview/). The
[Board](/storyletter/board/) is the everyday version of this page. Play the project and watch
what it deals.
...
and the review walk, leaving feedback on any item and stepping through it, are part of the
editor and live on [Reviewing](/storyletter/reviewing/). Gating a build on coverage in CI is
the last section of [Coverage testing](/production/coverage-testing/#gating-a-build-on-it).
